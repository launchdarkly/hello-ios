...
# Usage: From the project folder (e.g. 'hello-ios') run 'bash .circleci/run-build-locally.sh'
...
curl --user ${CIRCLE_TOKEN}: \
     ...
     --form notify=false \
        https://circleci.com/api/v1.1/project/github/launchdarkly/hello-ios/tree/circleci_2.0
